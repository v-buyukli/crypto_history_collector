...
# Get favicon path
FAVICON_PATH = STATIC_DIR / "images" / "favicon.svg"
...
with col1:
    render_exchange_card(name="Binance", logo_url=svg_to_data_uri("binance.svg"))

with col2:
    render_exchange_card(name="Bybit", logo_url=svg_to_data_uri("bybit.svg"))

with col3:
    render_exchange_card(name="OKX", logo_url=svg_to_data_uri("okx.svg"))
